...
- Difficile d'acheter des logiciels en magasin (très dur d'en trouver pour Linux), et les logiciels pour Windows ne fonctionnent sous Linux qu'au cas par cas (en utilisant <a href="http://fr.wikipedia.org/wiki/Wine" hreflang="fr">Wine</a>).
...
- Il peut être difficile d'installer une version récente d'une application si le distributeur de la <a href="http://fr.wikipedia.org/wiki/Distribution_GNU/Linux" hreflang="fr">distribution GNU/Linux</a> ne l'a pas mise à disposition.
