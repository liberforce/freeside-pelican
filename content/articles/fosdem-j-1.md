...
- [Frédéric](http://www.0d.be/) pour discuter de JhAutobuild et de la build brigade (et de sa nouvelle coupe de cheveux :-)).

Aurais-je le courage de faire la [migration GnomeDruid vers GtkAssistant dans Ekiga](http://bugzilla.gnome.org/show_bug.cgi?id=361135) (et en profiter pour automatiser un maximum de détection) ? D'écrire enfin un article pour le gnome-journal sur [JhAutobuild](http://jhbuild.bxlug.be/) ? La suite au prochain épisode, après le FOSDEM...
