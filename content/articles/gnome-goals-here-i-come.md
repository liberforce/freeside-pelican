...
Goals](http://live.gnome.org/GnomeGoals) were open. I've worked
...
symbols](http://live.gnome.org/GnomeGoals/RemoveDeprecatedSymbols/Glib)
...
[jhbuild](http://live.gnome.org/Jhbuild) and compiling the whole
stuff disabling deprecated Glib symbols, and [forbiding gtk/gdk/gdk-pixbuf
sub-headers direct
inclusion](http://live.gnome.org/GnomeGoals/CleanupGTKIncludes).
...
symbols](http://live.gnome.org/GnomeGoals/RemoveDeprecatedSymbols/GTK%2B),
