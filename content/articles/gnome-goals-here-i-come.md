...
The next step towards world domination will be the [removal of deprecated GTK+ symbols](http://live.gnome.org/GnomeGoals/RemoveDeprecatedSymbols/GTK%2B){hreflang="en"}, wich is longer and more complicated, as it required more testing.
