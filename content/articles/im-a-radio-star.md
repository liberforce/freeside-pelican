...
- [vous inscrire sur parinux.org](http://www.parinux.org/events/install-party-mandriva-linux-2008){hreflang="fr"} et venir à l'install party
- allumer votre radio sur 95.2 FM à 14H et écouter l'émission [*Hot-line*](http://icietmaintenant.info/emissions.php?idNouvelle=8){hreflang="fr"}
- aller sur le site de [radio ici et maintenant](http://icietmaintenant.com/){hreflang="fr"} et écouter l'émission en streaming
