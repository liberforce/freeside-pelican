...
status: "published"
---
[git-bz](http://git.fishsoup.net/cgit/git-bz/) is a utility written by [Owen Taylor](http://blog.fishsoup.net) to ease the workflow between git and the patches living in a bugzilla bugtracker. It allows uploading, applying patches to/from bugzilla from the command line.
