...
\**]{.underline} I have a CRT screen at home. When I listen to some music
...
[So here is my GNOME tip of the day: \]{.underline} *Step 1: move your mixer
applet to one corner*[\]{.underline} So I moved the mixer applet at the top
right corner of my desktop (works for every corner). For that, you need to
unlock the mixer applet and every applet that would prevent it from going on
the destop corner. To move the applet, use the traditionnal middle mouse
drag-and-drop.
