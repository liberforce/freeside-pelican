...
![Migration
applet]({static}/images/mandriva/migration_2009.0/migration-applet.png "Applet
de migration, oct 2008")
...
bit more. I was once again presented with the "new distro available"
notification popup. I clicked again on the applet, and was presented the distro
upgrade dialog.

!['New stable distribution
available]({static}/images/mandriva/migration_2009.0/Capture-Une_nouvelle_distribution_stable_est_disponible.png
"Une nouvelle distribution stable est disponible, oct 2008")
...
![]({static}/images/mandriva/migration_2009.0/Capture-Mise_a_jour_de_la_distribution2.png
"Mise à jour de la distribution, oct 2008")
...
![]({static}/images/mandriva/migration_2009.0/Capture-Felicitations.png
"Félicitations, oct 2008")
...
![aria error]({static}/images/mandriva/migration_2009.0/Capture-gurpmi2.png
"gurpmi, oct 2008")
...
interrupted. The drakxtooks couldn't be updated because the perl-Gtk2-Webkit
package was missing, and this message was blocking the whole update.

![drakxtools can't
install]({static}/images/mandriva/migration_2009.0/Capture-Certains_paquetages_ne_peuvent_pas_etre_installes.png
"Certains paquetages ne peuvent être installés, oct 2008")
...
![media
error]({static}/images/mandriva/migration_2009.0/Capture-Erreur-media.png
"Erreur média, oct 2008")
...
defaut applications), but most of the time, using the `init 3/urpmi --auto
--auto-select/init 5` technique (and not forgetting to upgrade the kernel too).
Oh, by the way, during the install, I had a warning telling me my /boot
...
![]({static}/images/mandriva/migration_2009.0/Capture-Felicitations-1.png
"Félicitations ok, oct 2008")
...
2009.0 ! However, fixing my "Main updates" media problem (the main miror set by
Aria had an MD5SUM error on the synthesis file for this media), was as easy as
setting by hand a new mirror, and looking for updates. The only broken thing
...
![]({static}/images/mandriva/migration_2009.0/menus-before.png "Menus (avant),
oct 2008")

After :

![]({static}/images/mandriva/migration_2009.0/menus-after.png "Menus (après),
oct 2008")
